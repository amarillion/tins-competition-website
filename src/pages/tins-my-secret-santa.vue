...
<template>
	<div class="tins-my-secret-santa">
...
<style scoped>
	.tins-my-secret-santa :deep(a) { font-weight: bold; text-decoration: none; }
	.tins-my-secret-santa :deep(a:link) { color: #600; }
	.tins-my-secret-santa :deep(a:hover) { text-decoration: underline; }
	.tins-my-secret-santa :deep(a:active) { text-decoration: underline; }
