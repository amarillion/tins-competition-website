...
<style scoped>
	.tins-about :deep(a) { font-weight: bold; text-decoration: none; }
	.tins-about :deep(a:link) { color: #600; }
	.tins-about :deep(a:hover) { text-decoration: underline; }
	.tins-about :deep(a:active) { text-decoration: underline; }
</style>
