...
<style scoped>
	.tins-support :deep(img) {
		max-width: 100%;
	}

	.tins-support :deep(a) { font-weight: bold; text-decoration: none; }
	.tins-support :deep(a:link) { color: #600; }
	.tins-support :deep(a:hover) { text-decoration: underline; }
	.tins-support :deep(a:active) { text-decoration: underline; }
</style>
