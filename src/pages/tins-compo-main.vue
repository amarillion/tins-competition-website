...
watch(compoId, () => {
	compo.doAsync(async () => fetchJSONOrThrow(`/api/v1/compo/${compoId.value}`));
}, { immediate: true });
...
<style scoped>
	.tins-compo-main :deep(a) { font-weight: bold; text-decoration: none; }
	.tins-compo-main :deep(a:link) { color: #600; }
	.tins-compo-main :deep(a:hover) { text-decoration: underline; }
	.tins-compo-main :deep(a:active) { text-decoration: underline; }
